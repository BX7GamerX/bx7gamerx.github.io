/* @ts-self-types="./helix_edge_wasm.d.ts" */
 ...
 * @returns {string}
 */
export function generate_sequence(length, mutation_rate) {
    let deferred1_0;
    let deferred1_1;
    try {
        const ret = wasm.generate_sequence(length, mutation_rate);
        deferred1_0 = ret[0];
        deferred1_1 = ret[1];
...
function __wbg_get_imports() {
    const import0 = {
        ...
        __wbg_now_7734ac7b82bd394d: function() {
...
async function __wbg_init(module_or_path) {
    ...
    if (module_or_path === undefined) {
        module_or_path = new URL('helix_edge_wasm_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
